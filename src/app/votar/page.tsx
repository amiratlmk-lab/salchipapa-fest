        ...
        <div className="min-h-screen bg-slate-950 text-white relative overflow-x-hidden selection:bg-yellow-500/30">
            ...
            <div className="relative z-10 flex flex-col min-h-screen pt-12">
                ...
                <div className="text-center px-4 mb-2">
                    ...
                    >
                        <Image src="/crown.png" alt="Crown" width={180} height={135} className="w-[180px] h-auto drop-shadow-lg mx-auto" />
                    </motion.div>
                    ...
                    <motion.h1
                        ...
                        className="text-3xl md:text-5xl text-[#fbcc04] uppercase leading-none tracking-tight mb-4 drop-shadow-md font-lilita max-w-3xl mx-auto"
                    >
                        ¡VOTA POR TU LOCAL<br />FAVORITO DE SALCHIPAPAS<br />EN PANAMÁ!
                    </motion.h1>

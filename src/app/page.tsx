  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white relative overflow-x-hidden selection:bg-yellow-500/30">
      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        ...
        {/* Hero Section */}
        <main className="flex-grow flex flex-col items-center justify-center px-4 pt-4 pb-2 md:pt-10 md:pb-12 text-center max-w-lg md:max-w-4xl mx-auto w-full">


          {/* Integrated Header: Sponsors + Main Logo */}
          <div className="relative w-full max-w-[260px] md:max-w-[360px] aspect-square flex justify-center items-center mb-0">
          ...
          <motion.h1
            ...
            className="text-2xl md:text-6xl text-[#fbcc04] uppercase leading-none tracking-tight mb-2 -mt-12 drop-shadow-md font-lilita"
          >
          ...
          <footer className="py-2 md:py-10 text-center text-white text-xs mt-4 md:mt-8 relative z-20">
        </main>

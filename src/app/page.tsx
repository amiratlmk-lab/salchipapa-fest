    ...
    <div className="min-h-screen bg-slate-950 text-white">
      ...
      >
        ...
        >
          ...
          <p className="text-lg md:text-3xl text-white max-w-3xl mx-auto leading-relaxed font-bold px-4">
            Vota por tu salchipapa favorita.
            <br className="block mb-4 md:mb-3" />
            <span className="text-yellow-400">¡Elige el sabor que manda en Panamá!</span>
          </p>
        </motion.div>
      </motion.header>
